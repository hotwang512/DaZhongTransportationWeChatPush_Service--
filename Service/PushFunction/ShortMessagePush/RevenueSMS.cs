...
{
    public class RevenueSMS : PushShortMsg
    {
        /// <summary>
        /// 发送短信验证码
        /// </summary>
        ...
        public override string Push(U_AccessToken accessTokenModel, U_Content contentModel)
        {
            ...
            //将短信营收实体转换微信
            U_Revenue_Temp_Para rtp = contentModel.Message.JsonToModel<U_Revenue_Temp_Para>();

            U_Para para = new U_Para();
            para.mobile = contentModel.PushObject[0].PhoneNumber.Trim();
            para.temp_id = Convert.ToInt32(ConfigSugar.GetAppString("Revenue_Temp_ID"));
            para.temp_para = rtp;
            ...
            LogManager.WriteLog(LogFile.Error, taskStr.Result);
