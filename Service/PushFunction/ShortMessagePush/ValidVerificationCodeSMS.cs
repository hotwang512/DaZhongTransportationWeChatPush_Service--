...
{
    public class ValidVerificationCodeSMS : PushShortMsg
    {
        /// <summary>
        /// 发送短信验证码
        /// </summary>
        ...
        public override string Push(U_AccessToken accessTokenModel, U_Content contentModel)
        {
            ...
            ///发送短信验证码参数
            U_VerificationCode_Temp_Para para = new U_VerificationCode_Temp_Para();
            para.code = contentModel.Message;
            //将参数转换为Json字符串
            ...
            //发送短信
            Task<HttpResponseMessage> taskHrm = httpClient.PostAsync(_validVerificationCodeUrl, sc);
